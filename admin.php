...
<body>
    <center>
        ...
        <form action='./admin.php' method="post">
            ...
            <button style="height: 50px;letter-spacing:0.5px;line-height: 50px;padding: 0 35px 0 35px;font-size: 15px;background-color: black;color: white;font-family: 'Open Sans Condensed';border:none;cursor:pointer" type="submit">SUBMIT</button>
        </form>
