...
<body>
    ...
    <div class="form-container">
        <div class="add-product-container">
            ...
            <form class="add-product-form" action='./Config/addProduct.php' method="post" enctype="multipart/form-data">
        ...
        <div class="add-product-container">
            <h1>REMOVE PRODUCT FROM THE SHOP</h1>
            <form class="add-product-form" action='./Config/removeProduct.php' method="post"
